...
async function establishPortalSession(req, portalUser, rememberMe) {
...
export async function portalSignupController(req, res) {
...
export async function portalLoginController(req, res) {
...
export async function portalLogoutController(req, res) {
    if (req.session.user) {
...
export async function portalSessionController(req, res) {
    res.setHeader("Cache-Control", "no-store");
...
export async function portalProfileUpdateController(req, res) {
...
export async function portalResendVerificationController(req, res) {
    const sessionUser = req.portalAuthUser;
...
export async function portalVerifyEmailController(req, res) {
