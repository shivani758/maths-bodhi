...
export const env = {
    ...
    SESSION_COOKIE_SAME_SITE: rawEnv.SESSION_COOKIE_SAME_SITE ?? (rawEnv.NODE_ENV === "production" ? "none" : "lax"),
    SESSION_COOKIE_SECURE: rawEnv.SESSION_COOKIE_SECURE ?? (rawEnv.NODE_ENV === "production"),
